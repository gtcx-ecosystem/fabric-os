---
title: 'Service Overview — gtcx-infrastructure'
status: 'current'
date: '2026-05-27'
...
│   │   ├── init-03-platform/scripts/         # DB initialization SQL
...
├── 03-platform/tools/                        # Additional operational scripts
├── 01-docs/                         # Docs, agent team, architecture, security
├── package.json
├── pnpm-workspace.yaml
├── tsconfig.json
└── turbo.json
