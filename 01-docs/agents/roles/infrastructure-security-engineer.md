---
title: 'Role: Infrastructure Security Engineer'
status: 'current'
date: '2026-05-27'
...
- `01-docs/09-security/` — threat model, security architecture, IAM policy register
...
Keeps `01-docs/09-security/threat-model.md` current as infrastructure changes introduce new attack surface. Documents every open gap with a severity, an owner, and a target sprint. Escalates any gap classified as HIGH or CRITICAL that has been open for more than two sprints.
...
1. Read `01-docs/09-security/security-architecture.md` — current security posture
2. Read `01-docs/09-security/threat-model.md` — open gaps and mitigations
3. Read `01-docs/09-security/iam-policy-register.md` — current IAM policy inventory
...
| Resource                | Location                                       |
| ----------------------- | ---------------------------------------------- |
| Security architecture   | `01-docs/09-security/security-architecture.md` |
