...
| Kubernetes deployability            | Infrastructure Lead   | Platform Lead       | `04-deploy/kubernetes/`, `.github/workflows/ci.yml`                                                                           |
| Terraform and AWS controls          | Infrastructure Lead   | SRE                 | `04-deploy/terraform/`                                                                                                        |
| DR and recovery                     | SRE                   | Infrastructure Lead | `04-deploy/03-platform/scripts/dr-test.sh`, `.github/workflows/dr-test.yml`                                                   |
