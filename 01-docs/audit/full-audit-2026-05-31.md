...
scoring_note: 'v1 certified_composite retired — use IR + XC per 01-docs/05-audit/SCORING.md v2'
supersedes: 01-docs/05-audit/full-audit-2026-05-22.md
---
...
- Machine scorecard: `01-docs/05-audit/latest.json` (stale head — updated in this session)
...
| ---------------- | ------------------------------------------------------------------------------- | ------------------------------------------ |
| SOC 2 Type I/II  | ~92% checklist mapped (`01-docs/08-gtm/regulatory/soc2-readiness-checklist.md`) | Plan ready; **no auditor**                 |
...
| Capacity          | **Gaps**         | HPA on gateway; soak-test gate not wired (S3-03); load-tests under `03-platform/tools/load-tests/` not in validate-all quick                            |
...
- Contract tests package (S3-09) — cross-repo schema fixtures already stubbed in `03-platform/tools/contract-tests/`.
...
| #   | Task                                 | Layer       | Files                                                                                            | Effort | Why It Matters         |
| --- | ------------------------------------ | ----------- | ------------------------------------------------------------------------------------------------ | ------ | ---------------------- |
| 1   | Pen-test SOW signature + vendor slot | Remediation | `01-docs/08-gtm/regulatory/pentest-scope-rfp.md`, `external-dependencies-register-2026-05-31.md` | human  | Certified score unlock |
| 2   | SOC 2 owner column per TSC row       | Evolution   | `01-docs/08-gtm/regulatory/soc2-readiness-checklist.md`                                          | 1d     | S2-12                  |
| 3   | Merge Tier 1+2 dependabot PRs        | Remediation | `.github/dependabot.yml`, open PRs                                                               | 1d     | Supply-chain hygiene   |
| 4   | IRP v1 board sign-off prep pack      | Evolution   | `01-docs/08-gtm/regulatory/incident-response-plan-v1.md`                                         | 0.5d   | Regulator-facing       |
