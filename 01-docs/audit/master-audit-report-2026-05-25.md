...
**Methodology:** `01-docs/05-audit/prompts/master-audit-prompt.md` (MAOP v1.0)  
...
| P1       | `03-platform/tools/audit-flush/Dockerfile` does not bundle `@gtcx/audit-signer` | Unblocked by npm publish (2026-05-22)       | Platform Engineering |
| P1       | Adaptive policy state is per-pod, not global                                    | Acceptable through pilot; Redis at >10 pods | Platform Engineering |
| P2       | `03-platform/tools/audit-flush/` lacks NATS integration test                    | Add docker-compose test before prod deploy  | Platform Engineering |
...
| Artifact            | Path                                                                |
| ------------------- | ------------------------------------------------------------------- |
| Master audit report | `01-docs/05-audit/master-audit-report-2026-05-25.md`                |
| Unified scorecard   | `01-docs/05-audit/prompts/evidence/unified-scorecard.json`          |
| P-GAP evidence      | `01-docs/05-audit/prompts/evidence/partnership-grade-evidence.json` |
| E-GAP evidence      | `01-docs/05-audit/prompts/evidence/enterprise-grade-evidence.json`  |
| I-GAP evidence      | `01-docs/05-audit/prompts/evidence/investment-grade-evidence.json`  |
| B-GAP evidence      | `01-docs/05-audit/prompts/evidence/bank-grade-evidence.json`        |
| G-GAP evidence      | `01-docs/05-audit/prompts/evidence/government-grade-evidence.json`  |
| Raw logs            | `01-docs/05-audit/prompts/evidence/raw/*.log`                       |
...
| ---------------------------------- | ------------------------------------------------------------------------------------ | ---------------------- |
| security.txt                       | `01-docs/09-security/.well-known/security.txt`                                       | P-GAP P.4, E-GAP E.7   |
| Partner incident notification SLA  | `01-docs/09-security/partner-incident-notification-sla.md`                           | P-GAP P.5              |
| Partner security self-assessment   | `01-docs/09-security/partner-security-self-assessment.md`                            | P-GAP P.7              |
| CISO role definition               | `01-docs/governance/ciso-role.md`                                                    | B-GAP B.4, I-GAP I.7   |
| AML monitoring policy              | `01-docs/10-compliance/aml-monitoring-policy.md`                                     | B-GAP B.6              |
| PAIA manual                        | `01-docs/10-compliance/paia-manual.md`                                               | G-GAP G.12             |
| FICA compliance framework          | `01-docs/10-compliance/fica-compliance.md`                                           | G-GAP G.12, B-GAP B.6  |
| Trust account framework            | `01-docs/financial/trust-account.md`                                                 | B-GAP B.9              |
| Accounting policies                | `01-docs/financial/accounting-policies.md`                                           | I-GAP I.6              |
| Expense policy                     | `01-docs/financial/expense-policy.md`                                                | I-GAP I.6              |
| POPIA registration                 | `01-docs/10-compliance/popia-registration.md`                                        | G-GAP G.12             |
| ROPA                               | `01-docs/10-compliance/popia-ropa.md`                                                | G-GAP G.12             |
| POPIA breach notification          | `01-docs/10-compliance/popia-breach-notification.md`                                 | G-GAP G.12             |
| Personnel security policy          | `01-docs/09-security/personnel-security-policy.md`                                   | G-GAP G.5              |
| Air-gapped deployment architecture | `01-docs/architecture/air-gapped-deployment.md`                                      | G-GAP G.7              |
| Red team scope & ROE               | `01-docs/05-audit/red-team-scope.md`                                                 | B-GAP B.3              |
| Ethics policy                      | `01-docs/governance/ethics-policy.md`                                                | G-GAP G.11             |
| King IV compliance mapping         | `01-docs/governance/king-iv-compliance.md`                                           | G-GAP G.11             |
| Board charter                      | `01-docs/governance/board-charter.md`                                                | I-GAP I.10, G-GAP G.11 |
| Regulatory contacts map            | `01-docs/10-compliance/regulatory-contacts.md`                                       | I-GAP I.8, B-GAP B.5   |
| RFP finalization                   | `01-docs/05-audit/pen-test-rfp-2026.md` + `01-docs/05-audit/soc2-engagement-2026.md` | E-GAP E.2 + E.1        |
