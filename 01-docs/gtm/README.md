...
**Trust architecture (authorities vs operators):** [gtcx-protocols canonical spec](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/01-docs/reference/architecture/trust-layers-and-did-resolution.md) · [infra cross-ref](../reference/architecture/trust-layers-and-did-resolution.md)
