...
| --- | ---------------------------------------------- | --------------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| 1.1 | `terraform apply` — VPC, EKS, RDS, ECR, KMS    | Not started     | **Done** — staging live since May 2026                                                             | `04-deploy/terraform/environments/staging/`                                                    |
| 1.2 | Deploy replay-guard, protocols, NATS to EKS    | Not started     | **Done** — `compliance-gateway-staging`, `gtcx-protocols-staging`, `redis-staging` all Running     | `04-deploy/kubernetes/overlays/staging/`                                                       |
| 1.3 | Deploy monitoring stack                        | Not started     | **Partial** — Prometheus/Grafana manifests committed; Alertmanager configured; no live traffic yet | `04-deploy/monitoring/`                                                                        |
