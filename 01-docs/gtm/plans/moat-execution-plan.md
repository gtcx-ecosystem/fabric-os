...
| 1.3 | Add 03-platform/examples/ directory (minimal, full, multi-jurisdiction)               | 2 hours | 3 working examples                                |
...
| #   | Task                                                                    | Effort  | Output                                                              |
| --- | ----------------------------------------------------------------------- | ------- | ------------------------------------------------------------------- |
| 2.1 | Design tool definitions for all 64 handlers (inputSchema, outputSchema) | 1 day   | `03-platform/tools/compliance-gateway/tools.json`                   |
| 2.2 | Build compliance gateway service (Node.js + AI SDK v6)                  | 2 days  | `03-platform/tools/compliance-gateway/`                             |
...
| 2   | Add outputs.tf + 03-platform/examples/ + comprehensive README | Moat #1 | 3 hours |
