...
#
# Usage:
#   ./03-platform/scripts/setup.sh              # Full setup
#   ./03-platform/scripts/setup.sh --check      # Check prerequisites only
#   ./03-platform/scripts/setup.sh --docker     # Docker setup only
#   ./03-platform/scripts/setup.sh --help       # Show help
# =============================================================================
