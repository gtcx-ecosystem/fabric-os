...
> **Canonical runbook:** [`01-docs/09-security/key-ceremony-runbook.md`](../security/key-ceremony-runbook.md)
> **Execution plan:** [`01-docs/08-gtm/plans/inf-86-hsovereign-key-ceremony-execution-plan.md`](../gtm/plans/inf-86-hsovereign-key-ceremony-execution-plan.md)
...
| 2   | Production configuration reviewed (gh-bog pilot)   | **done**    | `04-deploy/terraform/environments/production/main.tf:351-369`                                                                | infra        |
...
| 5   | H-02 operator runbook created                      | **done**    | [`01-docs/09-security/inf-86-h02-operator-runbook.md`](../security/inf-86-h02-operator-runbook.md)                         | infra        |
| 6   | XR-401-A agentic attestation (CISO + platform)     | **done**    | `pnpm check:inf86-xr401-attestation` passes in gtcx-protocols                                                              | protocols    |
| 7   | Algorithm decision documented (Option A: P-256)    | **done**    | Agentic attestation recorded — `gtcx-protocols/01-docs/05-audit/evidence/inf-86-xr-401-agentic-attestation-latest.json`    | governance   |
...
| --- | --------------------------------------- | ------------------------------------------------------------- |
| 1   | Signed ceremony log                     | `01-docs/05-audit/evidence/inf-86/ceremony-log-YYYY-MM-DD.md` |
| 2   | Video recording                         | `s3://gtcx-production-ceremonies/YYYY-MM-DD/`                 |
| 3   | CloudTrail events                       | AWS CloudTrail → S3 archive                                   |
| 4   | Terraform plan + apply output           | `01-docs/05-audit/evidence/inf-86/`                           |
| 5   | Key metadata (`describe-key` JSON)      | `01-docs/05-audit/evidence/inf-86/`                           |
| 6   | Witness attestation                     | Ceremony log signature                                        |
| 7   | Public key export (DER + JWK/multibase) | `01-docs/05-audit/evidence/inf-86/gh-bog-public-key/`         |
...
**Evidence:** `gtcx-protocols/01-docs/05-audit/evidence/authority-key-ceremony-latest.json`
**Commit:** `11f1f7ac`
...
- evidence: 01-docs/05-audit/evidence/inf-86/gh-bog-2026-06-03/
...
| ---- | --------------------------------------------------------------------------------------------------------- | -------- | ------------------------------------------------------------------------------- |
| 1    | `SIGNING_KEY_PROVIDER=kms` + `AWS_KMS_KEY_ID=alias/gtcx-production-sovereign-gh-bog` on sovereign-staging | **done** | `04-deploy/kubernetes/overlays/staging/patches/sovereign-staging-env.yaml`        |
...
| 1c   | `gtcx-platform-staging` SA annotated with staging IRSA role                                               | **done** | `04-deploy/kubernetes/overlays/staging/patches/platform-sa-irsa.yaml`             |
...
_Next review: After XR-401-B/C evidence lands — see [inf-86-agentic-ceremony-model](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/01-docs/06-coordination/inf-86-agentic-ceremony-model-2026-06-03.md)_
