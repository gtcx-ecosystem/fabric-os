...
source_roadmap: '01-docs/05-audit/10-10-remediation-plan-2026-05-27.md'
composite: 9.0
composite_raw: 8.95
investor: 8.9
enterprise: 8.6
...
**HEAD:** `dd4dcfe`  
**Auditor:** Codex CLI  
**Protocol:** master audit protocol from `gtcx-agentic` docs, using the canonical scoring framework available through `gtcx-docs/03-platform/tools/audit/audit-framework/`.
...
| Reference-grade status publication     | Complete | `01-docs/05-audit/latest.json` records current score, gates, evidence, and remaining gaps. |
