...
| --- | --------------------------------------------- | --------------------------------------------------------------------------- | ------------------ |
| 1.1 | Compliance gateway HTTP integration tests     | `03-platform/tools/compliance-gateway/tests/server.integration.test.mjs`    | ✅ Complete        |
| 1.2 | Replay-protection production-mode HTTP test   | `03-platform/tools/replay-protection/tests/production-fail-closed.test.mjs` | ✅ Complete        |
...
- `01-docs/05-audit/archive/master-audit-2026-05-11.md` — This audit document
