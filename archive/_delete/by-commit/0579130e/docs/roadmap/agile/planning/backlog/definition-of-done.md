...
- [ ] Affected runbook in `01-docs/04-ops/runbooks/` updated if operational procedure changed
...
- [ ] UAT evidence logged in `01-docs/05-audit/agile/qa-test-plan.md`
...
- [ ] All pre-release gates pass (see `01-docs/devops/release/release-checklist.md`)
