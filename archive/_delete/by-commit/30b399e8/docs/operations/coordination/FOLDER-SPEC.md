---
title: 'operations/coordination/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/coordination']
review_cycle: on-change
---

# `docs/operations/coordination/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/coordination/ narrative and specs for fabric-os.
