---
title: 'operations/core-ops/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/core-ops']
review_cycle: on-change
---

# `docs/operations/core-ops/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/core-ops/ narrative and specs for fabric-os.
