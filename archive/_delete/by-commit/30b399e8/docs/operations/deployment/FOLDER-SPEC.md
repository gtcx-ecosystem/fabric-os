---
title: 'operations/deployment/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/deployment']
review_cycle: on-change
---

# `docs/operations/deployment/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/deployment/ narrative and specs for fabric-os.
