---
title: 'Cross-repo agent bridge — fabric-os'
status: current
date: 2026-06-06
owner: fabric-os
tier: critical
...
# Cross-repo agent bridge — fabric-os

**Purpose:** Chat-style coordination surface for agents working **fabric-os** or reading infra blockers. Summarizes ecosystem state; links canonical sources of truth elsewhere.
...
| ---------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-06-12 | fabric-os → bridge-os | **Sprint authority eval delivered** (`XR-FABRIC-SPRINT-AUTH-001`). L2 hybrid witness; P22 fabric-only; ZenHub `sprintId` read-only. **Next:** bridge `fleet-sprint-orientation-latest.json` + `ecosystem:sprint:orientation:write`. [`from-fabric-os-sprint-authority-eval-2026-06-12.md`](./inbound/fabric-b/from-fabric-os-sprint-authority-eval-2026-06-12.md)                          |
| 2026-06-12 | bridge-os → fabric-os | **P24 sprint authority planning handoff** (`XR-FABRIC-SPRINT-AUTH-001`). L1 sprint SoR = product repo (`active.json`); L2 = fabric programme coordination (read-only witness). Reference: markets-os SPR-82 active · AFM-REG icebox. [`from-bridge-os-sprint-authority-ceremony-planning-2026-06-12.md`](./inbound/bridge/from-bridge-os-sprint-authority-ceremony-planning-2026-06-12.md) |
| 2026-06-07 | fabric-os             | **EXT-INF-002 pack ack** — gtcx-core FA-S6-02 vendor pack (22 artifacts) receipt acknowledged; attach to SOW. SOW signature Class S still open (S2-13). [`outbound/from-fabric-os-ext-inf-002-pack-ack-2026-06-07.md`](./outbound/from-fabric-os-ext-inf-002-pack-ack-2026-06-07.md)                                                                                                       |
| 2026-06-06 | fabric-os             | **Protocol 26 ACK — baseline-os Sprint 5 done:** Vault DR (S5-01), HPA autoscaling (S5-02), on-call rotation (S5-03) complete. Baseline-os repo-completable queue drained. No new blockers from infra.                                                                                                                                                                                     |
| 2026-06-06 | fabric-os             | **APPROVAL / UNBLOCK response:** Class S AWS SM/ESO terminal-os staging key — **ALREADY RESOLVED** (commit `3a794fa`, 44-byte aligned, health 200). Infra-side approval granted. External LOI remains human-gated.                                                                                                                                                                         |
| 2026-06-05 | fabric-os             | **W2-E2E UNBLOCKED:** `COMPLIANCE_OS_TERMINAL_API_KEY` aligned terminal-os ↔ compliance-os-w2-secrets. AWS SM updated, ESO sync verified, deployment restarted. Root cause: 44-byte key drift. Infrastructure scope complete.                                                                                                                                                              |
| 2026-06-05 | fabric-os             | **XR-507 DONE:** Verifier DNS live — `verify.explorationos.gtcx.trade/sir` 200 + pepper. Cloudflare Pages custom domain confirmed. F-33 audit unblocked.                                                                                                                                                                                                                                   |
| 2026-06-05 | fabric-os             | **XR-508 DONE:** Supabase project unpaused; `financing_applications` REST 200; migrations 006/007 applied. Financing prod path unblocked.                                                                                                                                                                                                                                                  |
| 2026-06-05 | fabric-os             | **XR-401 UNBLOCKED:** CISO algorithm sign-off received (ECC_NIST_P256 / ECDSA_SHA_256). XR-402 INF-86 pilot ceremony now ready for scheduling.                                                                                                                                                                                                                                             |
| 2026-06-05 | fabric-os             | **XR-405 DONE:** Platforms KMS sovereign signing wire-up complete. Staging IRSA role added to production KMS key policy. Sovereign staging can call `kms:Sign` for integration testing.                                                                                                                                                                                                    |
| 2026-06-05 | fabric-os             | **INT-R2-03 ROLLED OUT:** `kubectl apply` executed; deployment rolled out; pod env `ENABLE_COST_ROUTER=1` confirmed; `/health` probe returns `features.enableCostRouter: true`. INT-S8-01 unblocked.                                                                                                                                                                                       |
| 2026-06-04 | fabric-os             | **W2-OPS-001 DONE:** terminal-os staging deployed on EKS. AMD64 image built on EC2, pushed to ECR. ALB ingress + ACM cert + Cloudflare DNS live. `https://terminal-staging.gtcx.trade/api/health` → 200.                                                                                                                                                                                   |
| 2026-06-04 | fabric-os             | **INT-D05 DONE:** Staging EKS scaled 2→3 nodes (t3.medium). Litmus chaos operator installed in `litmus` namespace. Cluster capacity and chaos engineering readiness unblocked.                                                                                                                                                                                                             |
| 2026-06-04 | fabric-os             | **INT-R2-03 DONE:** `ENABLE_COST_ROUTER=1` added to intelligence-orchestrator staging Deployment. Unblocks INT-S8-01 for gtcx-intelligence. Precedent: compliance-gateway BASELINE_COST_ROUTER=1.                                                                                                                                                                                          |
| 2026-06-04 | fabric-os             | **ER-1-08 DONE:** Infra acknowledges EAP Phase B closure. `normalizeStatus()` fix is agentic-only; no infra code changes. No blockers.                                                                                                                                                                                                                                                     |
| 2026-06-03 | fabric-os             | **XR-104 DONE:** compliance-gateway DID resolve fixed. SDK rebuilt (audit-tradepass-auth-amd64), signing secret fixed (valid PKCS#8 DER Ed25519), rollout verified. Mobile E2E unblocked.                                                                                                                                                                                                  |
| 2026-06-03 | fabric-os             | **XR-201 finding:** `intelligence-orchestrator` Deployment manifest is **missing** from infra repo. ESO/ingress/secrets all live. Need gtcx-intelligence to provide full SDK image + manifest. See runbook.                                                                                                                                                                                |
| 2026-06-03 | fabric-os             | **XR-104 DONE:** compliance-gateway audit-tradepass-auth-amd64 deployed; signing init OK; DID resolver verified. Unblocks MOBILE-AUDIT-01.                                                                                                                                                                                                                                                 |
| 2026-06-03 | fabric-os             | **XR-202 READY:** Outbound handoff created for intelligence re-smoke. Full env spec + caveats in `outbound-handoff-xr-202-to-intelligence.md`.                                                                                                                                                                                                                                             |
| 2026-06-03 | fabric-os             | **XR-201 DONE:** Full intelligence SDK `12be5342` deployed to staging. Auth enforced on non-exempt paths. `/health` 200 by design (ALB health check); `/policy/rules` 401→200 with key.                                                                                                                                                                                                    |
| 2026-06-03 | fabric-os             | Coordination hub expanded: bridge + sprint workplan + outbound handoffs created. XR schemes reconciled (protocols canonical).                                                                                                                                                                                                                                                              |
...
| 2026-06-03 | fabric-os             | Track A complete per `from-gtcx-protocols-staging-operator-seed` (DONE). SM `gtcx/staging/mobile-audit-e2e-credentials` aligned.                                                                                                                                                                                                                                                           |
...
| 2026-06-02 | fabric-os             | #50–#52 audit presence live; evidence posted on GitHub.                                                                                                                                                                                                                                                                                                                                    |
...
| --------------------------- | ------ | ------------------------ | ---------------------- | ------------------ | ------ |
| Operator DID / mobile audit | XR-101 | **done**                 | fabric-os              | Mobile E2E         | —      |
| Mobile staging audit E2E    | XR-102 | **done**                 | gtcx-mobile            | MOBILE-AUDIT-01/02 | —      |
| compliance-gateway Bearer   | XR-104 | **done**                 | fabric-os              | XR-102             | R-high |
| Intelligence auth gate      | XR-201 | **done**                 | fabric-os              | XR-202 / INT-S3-08 | R-high |
...
| INF-86 pilot ceremony       | XR-402 | **ready**                | fabric-os              | XR-403             | R-high |
| SIR verifier prod           | XR-507 | **done** (2026-06-05)    | fabric-os              | F-33 audit close   | R-med  |
| Supabase migrations         | XR-508 | **done** (2026-06-05)    | fabric-os              | Financing prod     | R-med  |
...
| **P1**    | XR-507 | **fabric-os**              | **done** 2026-06-05 — DNS + Pages custom domain live             | F-33 audit close                                      |
| **P1**    | XR-508 | **fabric-os** / ops        | **done** 2026-06-05 — Project unpaused; migrations applied       | Financing prod                                        |
| **P2**    | XR-103 | **fabric-os**              | WAF rule for `/v1/admin/tradepass/register-operator` if needed   | Admin POST returns JSON                               |
| **DONE**  | XR-401 | CISO + platform-lead       | Algorithm decision — **ECC_NIST_P256 / ECDSA_SHA_256**           | XR-402 unblocked                                      |
| **READY** | XR-402 | **fabric-os**              | Pilot KMS ceremony `gh-bog` — UNBLOCKED for engineering          | Ceremony evidence + SPKI                              |
...
- Protocols → infra staging operator seed: [`from-gtcx-protocols-staging-operator-seed-2026-06-02.md`](./inbound/fleet-b/from-gtcx-protocols-staging-operator-seed-2026-06-02.md)
...
- Infra → platforms rollout: [`to-gtcx-platforms-rollout-ready-2026-06-03.md`](./inbound/to-b/to-gtcx-platforms-rollout-ready-2026-06-03.md)
