...
superseded_reason: 'Older remediation plan; replaced by reconciled 3-sprint plan.'
date: '2026-05-27'
...
> Source audit: [`01-docs/05-audit/master-audit-2026-05-27.md`](./master-audit-2026-05-27.md)  
...
| Reference-grade status JSON      | Complete | `01-docs/05-audit/latest.json` publishes current score, gate state, and evidence pointers after re-audit.                    |
...
| A4-003 | Map current infrastructure controls to SOC 2, ISO 27001, and NIST evidence in one evidence index. | `01-docs/10-compliance/` evidence matrix with file/test references. |
...
| R5-003 | Add CI badge or machine-readable JSON summarizing current audit score, gate status, and latest evidence bundle.                                                                              | `01-docs/05-audit/latest.json` or equivalent.                       |
