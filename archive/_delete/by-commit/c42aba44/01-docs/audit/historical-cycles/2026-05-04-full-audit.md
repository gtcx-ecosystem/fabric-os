...
| Consistency           | 6/10   | 6+ docs reference old `01-docs/` paths; `.baseline/config.json` still references `4-infrastructure`    |
...
- 6+ doc files reference old `01-docs/` paths
...
| ------------- | ----------- | ----------------------------------------------------------------------------------- |
| NIST 800-53   | Documented  | `01-docs/09-security/nist-800-53-mapping.md` exists; ~60% of controls mapped to IaC |
...
| 16  | 6+ docs reference old `01-docs/` paths                     | Phase 4 | Medium   | Open                     |
...
- The `01-docs/` directory structure would never have existed — flat `01-docs/` from the start
