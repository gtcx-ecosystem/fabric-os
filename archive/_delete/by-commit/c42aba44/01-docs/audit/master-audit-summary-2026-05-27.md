...
source_audit: '01-docs/05-audit/master-audit-rerun-2026-05-27.md'
...
| Strategic | Add machine-readable latest audit status.                                                           | `01-docs/05-audit/latest.json` or equivalent.     |
