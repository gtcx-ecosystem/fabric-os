...
- **Audit evidence:**
  - `01-docs/05-audit/master-audit-<DATE>.md` and `01-docs/05-audit/full-audit-<DATE>.md` both current within 90 days.
  - `01-docs/05-audit/signal-scorecard.json` aligned with master audit's narrative.
  - `01-docs/05-audit/score-evidence-ledger.json` with file:line pointers that still resolve.
- **Deployment evidence:**
...
- This overlay is referenced from `01-docs/05-audit/master-audit-<DATE>.md` Phase 0 (Pre-Flight); auditors must read both.
