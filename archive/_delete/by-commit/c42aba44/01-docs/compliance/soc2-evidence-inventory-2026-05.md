...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| CC1.1 Integrity and ethical values | [`CONTRIBUTING.md`](../operations/repo/CONTRIBUTING.md) · [`SECURITY.md`](../operations/repo/SECURITY.md) · [`01-docs/09-security/break-glass-procedure.md`](../security/break-glass-procedure.md) | 🟢    |
...
| CC1.5 Accountability               | [`01-docs/09-security/security-framework.md`](../security/security-framework.md) · [`04-deploy/security/policies/access-control.md`](../../04-deploy/security/policies/access-control.md)          | 🟢    |
...
| Control                        | Evidence                                                                                                                                                                                                                                                                                                                                    | Grade |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| CC4.1 Monitoring activities    | [`04-deploy/monitoring/dashboards/audit-trust.json`](../../04-deploy/monitoring/dashboards/audit-trust.json) · [`04-deploy/monitoring/dashboards/audit-trust-tenant.json`](../../04-deploy/monitoring/dashboards/audit-trust-tenant.json) — Grafana dashboards · `03-platform/tools/compliance-gateway/src/metrics.mjs` Prometheus exporter | 🟢    |
...
| CC5.3 Policy implementation       | [`04-deploy/kubernetes/base/policies/`](../../04-deploy/kubernetes/base/policies/) — Kyverno cluster policies                                                                                    | 🟢    |

### CC6 — Logical and Physical Access Controls

| Control                        | Evidence                                                                                                                                                                                                                                                                                                                  | Grade |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| CC6.1 Logical access           | [`03-platform/tools/compliance-gateway/src/auth.mjs`](../../03-platform/tools/compliance-gateway/src/auth.mjs) — bearer token, constant-time compare · IRSA via [`04-deploy/terraform/modules/irsa-platform/main.tf`](../../04-deploy/terraform/modules/irsa-platform/main.tf) · MFA documented in `01-docs/09-security/` | 🟢    |
...
| CC6.4 Encryption               | KMS at rest (RDS, S3, EBS, ECR) — see `04-deploy/terraform/modules/database/`, `04-deploy/terraform/modules/worm-audit/` · TLS 1.3 on ALB · Vault HA with KMS unseal                                                                                                                                                      | 🟢    |
...
| CC6.6 Network controls         | [`04-deploy/kubernetes/overlays/production/network-policies.yaml`](../../04-deploy/kubernetes/overlays/production/network-policies.yaml) — default-deny + explicit allow · `04-deploy/terraform/modules/flow-logs/` — VPC Flow Logs 365d retention                                                                        | 🟢    |
...
| Control                 | Evidence                                                                                                                                                                                                                          | Grade                                                                                  |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| CC7.1 Detection         | CloudTrail + GuardDuty via `04-deploy/terraform/modules/detective/` · `03-platform/tools/anomaly-detector/detector.mjs` 5 rules · `compliance_gateway_audit_sign_failures_total` Prometheus alert                                 | 🟢                                                                                     |
| CC7.2 Monitoring        | Prometheus + Grafana + Loki + Jaeger + Tempo stack (per `04-deploy/monitoring/`) · `/metrics` endpoint on every gateway pod                                                                                                       | 🟢                                                                                     |
...
| CC7.4 Recovery          | `.github/workflows/dr-test.yml` weekly DR + `dr-test-quarterly.yml` · `04-deploy/03-platform/scripts/dr-test.sh` with fail-fast cred guards                                                                                       | 🟡 (live restoration evidence pending capture in score-evidence ledger — INT-D-2 item) |
...
| ------------------------------ | -------------- | ------------------------------------------------------------------------------------------------------------------- | ----- | ---------------------------- |
| Live DR restoration evidence   | CC7.4          | Run `04-deploy/03-platform/scripts/dr-test.sh staging` with OUTPUT_DIR; link result in `score-evidence-ledger.json` | SRE   | Sprint 10 (HARD-V-002)       |
