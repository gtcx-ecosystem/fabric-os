...
| Related | [Infrastructure Architecture](../architecture/narratives/infrastructure-architecture-overview.md), [Security Policy](../../../../ops/security/narrative/security-policy.md), shared ecosystem architecture guidance |
...
This framework integrates with the existing [Incident Response](../operations/runbooks/deploy/incident-response.md) procedures:
...
- [Infrastructure Architecture](../architecture/narratives/infrastructure-architecture-overview.md) -- Deployment pipeline, environments, and edge architecture
