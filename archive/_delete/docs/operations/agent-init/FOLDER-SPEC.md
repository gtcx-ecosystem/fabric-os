---
title: 'operations/agent-init/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/agent-init']
review_cycle: on-change
---

# `docs/operations/agent-init/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/agent-init/ narrative and specs for fabric-os.
