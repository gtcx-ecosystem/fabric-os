---
title: 'operations/compliance/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/compliance']
review_cycle: on-change
---

# `docs/operations/compliance/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/compliance/ narrative and specs for fabric-os.
