...
**Evidence:** [`audit/evidence/ext-inf-002-countersign-approval-2026-06-10.json`](../../../../audit/archive/legacy-docs-audit/archive/2026-06-14/audit/evidence/ext-inf-002-countersign-approval-2026-06-10.json)
...
| Step                                     | Owner     | Status         |
| ---------------------------------------- | --------- | -------------- |
| Confirm test window with vendor          | fabric-os | **authorized** |
| Publish `pen-test-window-*.json` witness | fabric-os | pending        |
| Ingest vendor report                     | fabric-os | pending        |
| Close SEC-PENTEST-01 / SECAS-S2-01       | fabric-os | pending report |
