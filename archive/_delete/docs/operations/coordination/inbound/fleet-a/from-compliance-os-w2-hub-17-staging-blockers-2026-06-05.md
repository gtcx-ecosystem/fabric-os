...
**Infra reply:** [`to-compliance-os-hub-17-staging-blockers-witness-2026-06-05.md`](../to-b/to-compliance-os-hub-17-staging-blockers-witness-2026-06-05.md)
...
- Bootstrap: [`staging-compliance-os-eso-bootstrap.md`](../../../core-ops/batch-b/staging-compliance-os-eso-bootstrap.md).
...
| Artifact               | Path                                                                                                           |
| ---------------------- | -------------------------------------------------------------------------------------------------------------- |
| W2 secrets sealed      | [`from-fabric-os-w2-secrets-sealed-2026-06-05.md`](../fabric-b/from-fabric-os-w2-secrets-sealed-2026-06-05.md) |
