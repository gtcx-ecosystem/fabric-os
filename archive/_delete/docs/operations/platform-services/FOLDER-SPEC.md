---
title: 'operations/platform-services/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/platform-services']
review_cycle: on-change
---

# `docs/operations/platform-services/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/platform-services/ narrative and specs for fabric-os.
