---
title: 'operations/repo/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/repo']
review_cycle: on-change
---

# `docs/operations/repo/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/repo/ narrative and specs for fabric-os.
