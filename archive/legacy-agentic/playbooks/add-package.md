...
- `01-docs/engineering/2-system-design/overview.md` — environment topology and database separation rules
...
```
01-docs/5-specs/infrastructure/{component-name}.md
```
...
If the new component introduces a new service boundary, a new database, a new cloud resource type, or a new network zone, write an ADR before any code. See `01-docs/01-agents/workflows/tasks/write-adr.md`.
...
- [`01-docs/architecture/decisions/`](../../../architecture/decisions/README.md) — ADR index
