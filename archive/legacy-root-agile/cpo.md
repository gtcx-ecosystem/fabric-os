...
# CPO connection — fabric-os

**agile-os** is the tactical **Chief Product Officer** of the GTCX ecosystem. This repo participates via `docs/roadmap/agile/` — local ceremony only.
