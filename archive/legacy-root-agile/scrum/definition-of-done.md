---
title: 'Definition of Done — fabric-os'
status: current
date: 2026-05-27
owner: fabric-os
tier: standard
...
# Definition of Done — fabric-os

Quality criteria that must be satisfied before any work item in `fabric-os` is considered complete.
