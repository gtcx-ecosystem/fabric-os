...
| ----------------------------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- | -------------------------------- |
| Worktree clean                | FAIL   | ## feat/ai-cost-check<br> M audit/evidence/aaas-adversarial-honesty-latest.json<br> M audit/evidence/aaas-cadence-forecast-latest.json<br> M audit/evidence/aaas-cadence-history.json<br> M audit/evidence/aaas-cadence-latest.json<br> M audit/evidence/aaas-friction-check-latest.json<br> M audit/evidence/aaas-honesty-gate-latest.json<br> M audit/evidence/aaas-ownership-latest.json<br> M audit/evidence/agentic-innovation-audit-latest.json<br> M audit/evidence/codebuild-deploy-start-latest.json<br> M audit/evidence/compliance-pill... | Craft, Trust & Safety                           | Grounded                         |
...
| Fabric AaaS/DaaS              | PASS   | AaaS/DaaS evidence witnesses                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Technical Excellence, World Class               | Grounded, Actionable             |
...
| --------- | --: | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ---------- |
| 1         |  59 | L5 / 100 | Worktree clean, Critical docs preserved, Feature/spec registry, Foundational micro-audits, Transformational micro-audits, Root hygiene, Archive recoverability, MPR | worktree is dirty | incomplete |

## Blockers

- Worktree clean: worktree is dirty (## feat/ai-cost-check
  M audit/evidence/aaas-adversarial-honesty-latest.json
  M audit/evidence/aaas-cadence-forecast-latest.json
  M audit/evidence/aaas-cadence-history.json
  M audit/evidence/aaas-cadence-latest.json
  M audit/evidence/aaas-friction-check-latest.json
  M audit/evidence/aaas-honesty-gate-latest.json
  M audit/evidence/aaas-ownership-latest.json
  M audit/evidence/agentic-innovation-audit-latest.json
  M audit/evidence/codebuild-deploy-start-latest.json
  M audit/evidence/compliance-pill...)
