...
Created at the end of any session with in-progress work. Stored in `01-docs/sessions/`.
...
- Every `01-docs/` folder has a README explaining what belongs there
- ADRs in `01-docs/architecture/decisions/` capture significant infrastructure decisions
...
- Using patterns that contradict `01-docs/engineering/` standards
...
| `01-docs/sessions/YYYY-MM-DD-handoff.md`  | Session handoff             | End of every session with in-progress work         |
| ADRs in `01-docs/architecture/decisions/` | Decision record             | When significant infrastructure decisions are made |
