...
**Incident response**
Owns incident response runbooks for all operational failure modes. Runbooks follow the standard in `01-docs/04-ops/runbooks/template.md`: context-free diagnosis steps, explicit decision trees, escalation triggers, rollback commands. Runs post-incident reviews after every SEV-1 and SEV-2 incident and updates the relevant runbook within one sprint of the review.
