...
| 6   | **mTLS / service-mesh plan**         | 2            | Documented architecture decision in `01-docs/architecture/decisions/` with implementation phases; no committed binaries                                                      | In Progress |
