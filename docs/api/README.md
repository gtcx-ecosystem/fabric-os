...
A token may carry multiple permissions. Token issuance and rotation: see [`../ops/security/narrative/credential-rotation-log.md`](../../ops/security/narrative/credential-rotation-log.md).
