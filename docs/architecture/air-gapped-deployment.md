...
| Offline replay        | `03-platform/tools/replay-guard/` test suite | All tests pass without internet       |

## 8. Operational Runbooks

| Scenario                        | Runbook                                                 | Location      |
| ------------------------------- | ------------------------------------------------------- | ------------- |
| Air-gapped deployment bootstrap | `01-docs/04-ops/runbooks/air-gapped-bootstrap.md`       | To be created |
| Physical artifact transfer      | `01-docs/04-ops/runbooks/guarded-courier-procedure.md`  | To be created |
| HSM key ceremony (offline)      | `01-docs/09-security/key-ceremony-runbook.md`           | Exists        |
| Emergency patch in air-gap      | `01-docs/04-ops/runbooks/air-gapped-emergency-patch.md` | To be created |
