...
1. **Not code-centric**: Developers may initially look for src/, apps/
...
### Traditional Software Structure (docs/, src/, etc.)
...
- [Original ADR-001 from [Protocol Partner]](https://github.com/gtcx/gtcx/docs/02-architecture/decisions/ADR-001-monorepo-structure.md)
