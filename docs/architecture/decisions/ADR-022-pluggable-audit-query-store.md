...
flowchart TB
    ...
    InMem["InMemoryQueryStore<br/>tools/compliance-gateway/<br/>src/audit-query/store.mjs"]
    Ndjson["NdjsonQueryStore<br/>tools/compliance-gateway/<br/>src/audit-query/ndjson-store.mjs"]
...
- `tools/compliance-gateway/src/audit-query/` — source
