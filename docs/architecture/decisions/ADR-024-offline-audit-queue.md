...
- `tools/compliance-gateway/src/audit-sink.mjs` — current sink implementation
- `tools/chaos-tests/offline-queue-restart.test.mjs` — M2 acceptance test (to be created)
