---
title: 'GTCX Infrastructure -- Architecture Overview'
status: 'current'
date: '2026-05-27'
...
### Automation and Templates (03-platform/tools/)

| Component            | Purpose                                                                                         |
| -------------------- | ----------------------------------------------------------------------------------------------- |
| 03-platform/scripts/ | Setup, migration, seeding, and deployment automation (setup.sh, migrate.sh, seed.sh, deploy.sh) |
