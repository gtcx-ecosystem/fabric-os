---
title: 'architecture/integration/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'architecture/integration']
review_cycle: on-change
---

# `docs/architecture/integration/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

architecture/integration/ narrative and specs for fabric-os.
