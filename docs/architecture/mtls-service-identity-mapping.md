...
See `infra/kubernetes/overlays/{staging,production}/linkerd/canary-rollout.yaml` for phased rollout manifests.
...
node tools/scripts/verify-mesh-injection.mjs
...
- `infra/kubernetes/overlays/production/linkerd/mesh-policies.yaml`
- `infra/kubernetes/overlays/staging/linkerd/mesh-policies.yaml`
