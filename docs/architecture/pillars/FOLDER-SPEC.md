---
title: 'architecture/pillars/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'architecture/pillars']
review_cycle: on-change
---

# `docs/architecture/pillars/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

architecture/pillars/ narrative and specs for fabric-os.
