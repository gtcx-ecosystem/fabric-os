---
title: 'architecture/requirements/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'architecture/requirements']
review_cycle: on-change
---

# `docs/architecture/requirements/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

architecture/requirements/ narrative and specs for fabric-os.
