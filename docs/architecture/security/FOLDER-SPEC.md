---
title: 'architecture/security/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'architecture/security']
review_cycle: on-change
---

# `docs/architecture/security/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

architecture/security/ narrative and specs for fabric-os.
