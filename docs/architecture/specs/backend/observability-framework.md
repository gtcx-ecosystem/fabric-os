...
- [Infrastructure Architecture](../architecture/narratives/infrastructure-architecture-overview.md) -- Deployment topology, Kubernetes configuration, and monitoring infrastructure
