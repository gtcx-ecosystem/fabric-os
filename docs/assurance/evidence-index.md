...
| Kind              | Path                                     | Format        |
| ----------------- | ---------------------------------------- | ------------- |
| CI / gate witness | `docs/operations/evidence/*.json`        | Redacted JSON |
| Audit closure     | `docs/audit/evidence/*.json`             | Redacted JSON |
| Coordination ack  | `docs/operations/coordination/from-*.md` | Markdown      |
