...
| Field             | Value                                                                                                                |
| ----------------- | -------------------------------------------------------------------------------------------------------------------- |
| **Legal SoR**     | [gtcx-docs docs/legal](https://github.com/gtcx-ecosystem/gtcx-docs/tree/main/docs/legal/)                            |
| **Hub packets**   | [gtcx-docs human-gates/packets](https://github.com/gtcx-ecosystem/gtcx-docs/tree/main/docs/gtm/human-gates/packets/) |
...
| `docs/legal/*.md`                                | Product-only ToS/privacy when shipped |
