...
| Field                | Value                                                                                                                      |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| **Process SoR**      | [gtcx-protocols pen-test/process](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/docs/gtm/pen-test/process.md) |
...
- Update scope table in `docs/gtm/pen-test/README.md`
