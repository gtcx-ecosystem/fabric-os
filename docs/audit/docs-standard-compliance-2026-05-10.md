...
| README-only acceptance failures                            | `docs/`, `docs/gtm/`           | Added [`docs/documentation-governance.md`](../documentation-governance.md) and [`docs/gtm/overview.md`](../gtm/overview.md) as substantive non-README anchor docs. |
