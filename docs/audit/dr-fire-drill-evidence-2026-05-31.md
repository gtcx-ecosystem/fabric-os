...
> **pending** — requires operator credentials per `infra/scripts/dr-test.sh`.
...
| Script path                       | `infra/scripts/dr-test.sh` |
...
./infra/scripts/dr-test.sh staging docs/audit/evidence/
```
