...
| Script path                         | `infra/scripts/rds-live-restore.sh` |
...
Full evidence: [`docs/audit/evidence/rds-restore/rds-restore-operational-staging-20260604-080937.json`](./evidence/rds-restore/rds-restore-operational-staging-20260604-080937.json)
