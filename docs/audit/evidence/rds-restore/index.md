...
- [`infra/scripts/rds-live-restore.sh`](../../../../infra/scripts/rds-live-restore.sh) — Live restore script
- [`docs/audit/execution-roadmap.md`](../../execution-roadmap.md) — S3-07 story tracking
