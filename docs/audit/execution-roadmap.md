...
| S2-02 | Wire Redis `budget-store` into checkBudget/recordSpend/getSpend       | **done** (working tree, 2026-05-31) — async budget API delegates to budget-store; server + audit handlers await shared store-backed gates    |
