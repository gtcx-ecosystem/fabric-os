...
| S2-06 | CSP + bidi/RTL stripping in HTML evidence renderer                    | **done** (working tree, 2026-05-31) — restrictive CSP header/meta added; visible HTML fields strip bidi control characters                   |
