...
| S4-02 | PRD-002 Tier A: staging `/audit/*` reachable (≠404) + evidence probe script in CI               | **in progress** — probe generates durable artifacts; wired into `deploy-staging.yml` |
