...
| S2-03 | Bound `auth-failure-throttle` ipState Map + atomic recordAndCheck     | **done** (working tree, 2026-05-31) — max tracked IP cap + LRU eviction; failure path uses atomic record-and-check helper                    |
