...
| **EXT-INF-010** | Vendor/legal signature on SOC2 + pen-test SOWs                                                                   | Legal / procurement | security-lead         | Phase 3 start                                 | **open**                                                                                       | S52                   | Files under `docs/audit/vendor-outreach/`                                                                    | Composite −0.5  |
...
| -------------------------------------------------------------- | ---------------------------------------------------- | ------------------------------------------------------------------------------ |
| PagerDuty hardcoded key                                        | Env var substitution                                 | `infra/docker/observability/alertmanager.yml` `${PAGERDUTY_*}`                 |
| Audit endpoint QPS                                             | `checkBudget` on `/audit/bundles` and `/audit/query` | `tools/compliance-gateway/src/server.mjs`                                      |
...
| Release evidence generator       | `tools/control-plane/generate-release-evidence.mjs`                                    |
| WORM upload wrapper              | `tools/control-plane/upload-release-evidence-to-worm.mjs`                              |
| Pen-test RFP / scope / shortlist | `docs/audit/pen-test-*.md`                                                             |
| SOC2 evidence inventory          | `docs/compliance/soc2-evidence-inventory-2026-05.md`                                   |
