...
- **compliance-gateway** (HTTP API, `tools/compliance-gateway/`): `/v1/query`, `/v1/tools`, `/v1/providers`, `/v1/audit/chain`, `/v1/audit/verify`, `/v1/audit/bundles`, `/v1/audit/query`, `/v1/budget`, `/metrics`, `/health`.
