...
- [ ] Run all policy validators:
  ...
  - [ ] `node tools/scripts/validate-score-ledger.mjs`
  - [ ] `node tools/scripts/validate-signal.mjs`
  - [ ] `node tools/scripts/docs-standard-validator.mjs`
- [ ] Generate fresh release evidence: `node tools/control-plane/generate-release-evidence.mjs`
...
- [ ] Archive prior audit to `docs/audit/archive/`
...
| ------------------------ | --------- | ------------------------------------------------- |
| Master audit reports     | 7 years   | `docs/audit/archive/`                             |
| Score evidence ledger    | 7 years   | `docs/audit/score-evidence-ledger.json`           |
| CI build artifacts       | 90 days   | GitHub Actions                                    |
| Release evidence bundles | 7 years   | `infra/security/reports/release-evidence/`        |
| Pen-test reports         | 7 years   | `docs/audit/pen-test-report-YYYY-MM-DD.md`        |
| SOC 2 reports            | 7 years   | `docs/compliance/soc2-type1-attestation-YYYY.pdf` |
| On-call drill evidence   | 3 years   | `docs/devops/drills/`                             |
...
- Master audit methodology: `docs/audit/master-audit-2026-05-17.md`
- Score evidence ledger: `docs/audit/score-evidence-ledger.json`
- SIGNAL scorecard: `docs/audit/signal-scorecard.json`
- Remediation plan: `docs/audit/remediation-plan-10-10-2026.md`
- SOC 2 readiness: `docs/compliance/soc2-readiness-checklist.md`
