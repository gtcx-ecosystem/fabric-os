...
```text
infra/security/reports/worm-evidence/2026-05-27/master-audit-remediation.ndjson
```
...
aws s3api put-object \
  ...
  --body infra/security/reports/worm-evidence/2026-05-27/master-audit-remediation.ndjson \
