---
title: 'business/case-studies/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'business/case-studies']
review_cycle: on-change
---

# `docs/business/case-studies/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

business/case-studies/ narrative and specs for fabric-os.
