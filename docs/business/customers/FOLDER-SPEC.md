---
title: 'business/customers/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'business/customers']
review_cycle: on-change
---

# `docs/business/customers/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

business/customers/ narrative and specs for fabric-os.
