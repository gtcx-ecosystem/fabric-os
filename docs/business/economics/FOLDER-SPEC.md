---
title: 'business/economics/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'business/economics']
review_cycle: on-change
---

# `docs/business/economics/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

business/economics/ narrative and specs for fabric-os.
