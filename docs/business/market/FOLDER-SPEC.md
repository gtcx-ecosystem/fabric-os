---
title: 'business/market/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'business/market']
review_cycle: on-change
---

# `docs/business/market/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

business/market/ narrative and specs for fabric-os.
