---
title: 'business/partnerships/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'business/partnerships']
review_cycle: on-change
---

# `docs/business/partnerships/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

business/partnerships/ narrative and specs for fabric-os.
