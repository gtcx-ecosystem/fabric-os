---
title: 'business/sales/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'business/sales']
review_cycle: on-change
---

# `docs/business/sales/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

business/sales/ narrative and specs for fabric-os.
