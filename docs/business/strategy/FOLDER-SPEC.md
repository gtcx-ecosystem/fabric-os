---
title: 'business/strategy/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'business/strategy']
review_cycle: on-change
---

# `docs/business/strategy/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

business/strategy/ narrative and specs for fabric-os.
