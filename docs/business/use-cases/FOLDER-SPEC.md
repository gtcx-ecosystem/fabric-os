---
title: 'business/use-cases/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'business/use-cases']
review_cycle: on-change
---

# `docs/business/use-cases/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

business/use-cases/ narrative and specs for fabric-os.
