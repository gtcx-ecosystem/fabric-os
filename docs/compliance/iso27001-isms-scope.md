...
| A.5.4  | Management responsibilities                                       | Yes        | Tone from the top             | PLANNED     | Board security committee charter pending                                           |
| A.5.5  | Contact with authorities                                          | Yes        | Regulatory obligations        | PLANNED     | Regulatory pre-notification agreements pending (Phase 2.4)                         |
...
| A.5.24 | Information security incident management planning and preparation | Yes        | Incident readiness            | PLANNED     | IRP v1.0 to be created (Phase 2.4)                                                 |
