...
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| CC1.1 Integrity and ethical values | [`CONTRIBUTING.md`](../../CONTRIBUTING.md) · [`SECURITY.md`](../../SECURITY.md) · [`docs/security/break-glass-procedure.md`](../security/break-glass-procedure.md)          | 🟢    |
| CC1.2 Board oversight              | [`docs/compliance/board-security-committee-charter.md`](./board-security-committee-charter.md)                                                                              | 🟢    |
| CC1.3 Org structure + reporting    | [`docs/security/security-framework.md`](../security/security-framework.md) §SoD                                                                                             | 🟢    |
| CC1.4 Commitment to competence     | [`docs/agents/onboarding/`](../agents/onboarding/) · [`docs/operations/runbooks/`](../operations/runbooks/) — 24 runbooks                                                   | 🟢    |
| CC1.5 Accountability               | [`docs/security/security-framework.md`](../security/security-framework.md) · [`infra/security/policies/access-control.md`](../../infra/security/policies/access-control.md) | 🟢    |
...
| Control                        | Evidence                                                                                                                                                                                                                                                                                                        | Grade |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| CC4.1 Monitoring activities    | [`infra/monitoring/dashboards/audit-trust.json`](../../infra/monitoring/dashboards/audit-trust.json) · [`infra/monitoring/dashboards/audit-trust-tenant.json`](../../infra/monitoring/dashboards/audit-trust-tenant.json) — Grafana dashboards · `tools/compliance-gateway/src/metrics.mjs` Prometheus exporter | 🟢    |
...
| Control                           | Evidence                                                                                                                                                                 | Grade |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----- |
| CC5.1 Selection of activities     | [`docs/audit/repo-overlay.md`](../audit/repo-overlay.md) — per-repo stricter caps over ecosystem baseline                                                                | 🟢    |
| CC5.2 Technology general controls | [`tools/scripts/validate-all.mjs`](../../tools/scripts/validate-all.mjs) — 17 gates · [`.github/workflows/ci.yml`](../../.github/workflows/ci.yml) — PR-gate enforcement | 🟢    |
| CC5.3 Policy implementation       | [`infra/kubernetes/base/policies/`](../../infra/kubernetes/base/policies/) — Kyverno cluster policies                                                                    | 🟢    |

### CC6 — Logical and Physical Access Controls

| Control                        | Evidence                                                                                                                                                                                                                                                                            | Grade |
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| CC6.1 Logical access           | [`tools/compliance-gateway/src/auth.mjs`](../../tools/compliance-gateway/src/auth.mjs) — bearer token, constant-time compare · IRSA via [`infra/terraform/modules/irsa-platform/main.tf`](../../infra/terraform/modules/irsa-platform/main.tf) · MFA documented in `docs/security/` | 🟢    |
| CC6.2 Onboarding/offboarding   | [`docs/security/break-glass-procedure.md`](../security/break-glass-procedure.md) — 15-min max session, two-person rule · [`docs/operations/runbooks/tenant-onboarding.md`](../operations/runbooks/tenant-onboarding.md)                                                             | 🟢    |
| CC6.3 Authentication           | `tools/compliance-gateway/src/auth.mjs:153-160` — constant-time token compare · per-principal token budget + QPS limiter in `tools/compliance-gateway/src/budget.mjs`                                                                                                               | 🟢    |
| CC6.4 Encryption               | KMS at rest (RDS, S3, EBS, ECR) — see `infra/terraform/modules/database/`, `infra/terraform/modules/worm-audit/` · TLS 1.3 on ALB · Vault HA with KMS unseal                                                                                                                        | 🟢    |
| CC6.5 Logical access removal   | [`docs/operations/runbooks/tenant-onboarding.md`](../operations/runbooks/tenant-onboarding.md) §Decommissioning — token revocation; WORM history preserved                                                                                                                          | 🟢    |
| CC6.6 Network controls         | [`infra/kubernetes/overlays/production/network-policies.yaml`](../../infra/kubernetes/overlays/production/network-policies.yaml) — default-deny + explicit allow · `infra/terraform/modules/flow-logs/` — VPC Flow Logs 365d retention                                              | 🟢    |
...
| Control                 | Evidence                                                                                                                                                                                                              | Grade                                                                                  |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| CC7.1 Detection         | CloudTrail + GuardDuty via `infra/terraform/modules/detective/` · `tools/anomaly-detector/detector.mjs` 5 rules · `compliance_gateway_audit_sign_failures_total` Prometheus alert                                     | 🟢                                                                                     |
| CC7.2 Monitoring        | Prometheus + Grafana + Loki + Jaeger + Tempo stack (per `infra/monitoring/`) · `/metrics` endpoint on every gateway pod                                                                                               | 🟢                                                                                     |
| CC7.3 Incident response | 25 runbooks in `docs/operations/runbooks/` · drill #002 executed (`docs/devops/drills/`) · PagerDuty drill simulation in `validate.sh`                                                                                | 🟢                                                                                     |
| CC7.4 Recovery          | `.github/workflows/dr-test.yml` weekly DR + `dr-test-quarterly.yml` · `infra/scripts/dr-test.sh` with fail-fast cred guards                                                                                           | 🟡 (live restoration evidence pending capture in score-evidence ledger — INT-D-2 item) |
| CC7.5 Resilience        | Multi-provider LLM fallback · per-principal QPS + daily budget · adaptive policy auto-degrades under sustained breach (`tools/compliance-gateway/src/adaptive-policy.mjs`) · audit-flush quarantines tampered batches | 🟢                                                                                     |
...
| Control                   | Evidence                                                                                                                                   | Grade |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ----- |
| CC9.1 Risk identification | Master audit cadence (quarterly) · forensic recalc when scores drift (per `docs/audit/master-audit-2026-05-17.md` §9 honest recalculation) | 🟢    |
| CC9.2 Risk mitigation     | Per-finding remediation ledger at `docs/audit/score-evidence-ledger.json` with git commit references                                       | 🟢    |

## SIGNAL-specific evidence (regulator-facing)

GTCX maintains the SIGNAL agentic-maturity scorecard at [`docs/audit/signal-scorecard.json`](../audit/signal-scorecard.json) with current overall score **9.60/10**. Per-pillar evidence:
...
| ------------------------------ | -------------- | --------------------------------------------------------------------------------------------------- | ----- | ---------------------------- |
| Live DR restoration evidence   | CC7.4          | Run `infra/scripts/dr-test.sh staging` with OUTPUT_DIR; link result in `score-evidence-ledger.json` | SRE   | Sprint 10 (HARD-V-002)       |
...
- [`docs/audit/soc2-engagement-2026.md`](../audit/soc2-engagement-2026.md) — engagement plan + auditor shortlist
- [`docs/compliance/dpia-2026-05.md`](./dpia-2026-05.md) — GDPR/CCPA DPIA (companion document)
- [`docs/audit/signal-scorecard.json`](../audit/signal-scorecard.json) — SIGNAL agentic-maturity scorecard
