...
| ServiceAccount manifest | `infra/kubernetes/base/service-accounts/gtcx-platforms.yaml`                   | ✅ In repo |
...
1. **Apply ServiceAccount** to production EKS:
   ...
   ```bash
   kubectl apply -f infra/kubernetes/base/service-accounts/gtcx-platforms.yaml
   ```
