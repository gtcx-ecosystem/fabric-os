---
title: 'gitbook/docs-site/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/docs-site']
review_cycle: on-change
---

# `docs/gitbook/docs-site/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/docs-site/ narrative and specs for fabric-os.
