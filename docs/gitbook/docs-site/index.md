...
- **SIGNAL scorecard:** [`signal-scorecard.json`](https://github.com/gtcx-ecosystem/gtcx-infrastructure/blob/main/docs/audit/signal-scorecard.json) — current score: **9.60/10**
