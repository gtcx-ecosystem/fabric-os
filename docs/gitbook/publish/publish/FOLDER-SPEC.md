---
title: 'gitbook/publish/publish/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'gitbook/publish/publish']
review_cycle: on-change
---

# `docs/gitbook/publish/publish/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

gitbook/publish/publish/ narrative and specs for fabric-os.
