...
| [`../agile/`](../agile/)   | Sprint planning (20 files) including the active `execution-roadmap-2026-05-22.md`.                                                                       | Could fold into `operations/sprint-plans/`. Kept top-level for now because operators routinely navigate to `docs/agile/` directly. May fold in a future cleanup. |
...
| ------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------------- |
| `docs/decisions/` (24 files)          | `architecture/decisions/`                                    | Protocol 1 v2.0: ADRs go in `architecture/`          |
| `docs/ecosystem/` (2 files)           | `architecture/`                                              | Cross-repo references are architectural              |
| `docs/principles/` (4 files)          | `architecture/principles/`                                   | Design principles guide architecture                 |
| `docs/remediation/` (2 files)         | `audit/remediation/`                                         | Audit follow-up belongs in `audit/`                  |
| `docs/research/` (4 files)            | `reference/`                                                 | Reference research material                          |
| `docs/release/` (5 files)             | `operations/release/`                                        | Release governance is operational                    |
| `docs/ml/model-cards/` (6 files)      | `governance/model-cards/`                                    | Protocol 1 v2.0: model cards in `governance/`        |
| `docs/assessments/` (16 files)        | `audit/` + `audit/historical-cycles/` + `audit/remediation/` | Audit assessments are audit content                  |
| `docs/devops/` (24 files)             | `operations/` + subfolders                                   | DevOps is operational by definition                  |
| `docs/external/` (13 files)           | `gitbook/`                                                   | Protocol 1 v2.0: external product docs in `gitbook/` |
| `docs/onboarding/` (2 redirect-stubs) | (deleted)                                                    | Canonical onboarding already at `agents/onboarding/` |
...
- Repo-relative code paths (`tools/...`, `infra/...`) when referring to this repo's own non-doc files
