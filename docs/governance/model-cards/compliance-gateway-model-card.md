...
**Benchmark:** `03-platform/tools/eval-pipeline/benchmarks/compliance-gateway.json`  
...
**Eval Pipeline:** `03-platform/tools/eval-pipeline/eval.mjs --model=compliance-gateway`  
