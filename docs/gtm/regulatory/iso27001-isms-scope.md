...
| A.5.24 | Information security incident management planning and preparation | Yes        | Incident readiness            | IMPLEMENTED | Incident Response Plan v1.0 published in docs/gtm/regulatory/                        |
