...
- `01-docs/architecture/decisions/README.md` — current index and numbering
- `01-docs/architecture/decisions/adr-template.md` — mandatory template
...
Check the current highest number in `01-docs/architecture/decisions/README.md`. Use the next available number: `NNN`.

---

### 2. Create the ADR file

File path: `01-docs/architecture/decisions/NNN-<kebab-case-title>.md`

Use `01-docs/architecture/decisions/adr-template.md` exactly. Fill every section:
...
Add the new ADR to `01-docs/architecture/decisions/README.md`:
...
- [ ] `01-docs/architecture/decisions/README.md` is updated
