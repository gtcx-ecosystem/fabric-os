...
**Agentic log (append-only):** [gtcx-agentic agent-coordination-log](https://github.com/gtcx-ecosystem/gtcx-agentic/blob/main/docs/operations/coordination/agent-coordination-log.md)  
