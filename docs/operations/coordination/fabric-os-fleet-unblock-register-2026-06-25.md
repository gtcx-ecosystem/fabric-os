...
| --------- | ------------- | ------------------------------------ | ----------------------------------------------------------------------------------------------- | ---------- | ----- | -------- | ------------------------- |
| F-prod-06 | griot-ai      | STORY-GRIOT-HTTPS-001                | api.griot.ai production HTTPS verified green (Dynadot CNAME + DNS repoint + ALB HTTPS listener) | infra      | A     | P0       | awaiting_operator_action  |
...
| FB-016    | ledger-os     | STORY-G4-2                           | ledger-os P4 durable DNS/TLS host provisioning                                                  | infra      | A     | P1       | closed                    |
