...
# Inbound: EXT-INF-002 vendor pen-test pack (FA-S6-02)
...
| Scope     | Complements infra [`pen-test-intake-evidence-2026-05-31.md`](../../audit/archive/legacy-docs-audit/archive/legacy-docs-audit/archive/legacy-docs-audit/archive/legacy-docs-audit/archive/legacy-docs-audit/pen-test-intake-evidence-2026-05-31.md) — not substitute for live-stack test |

## Infra posture

- **Pack receipt:** **acknowledged** — attach to SensePost/Nclose SOW kickoff
- **SOW signature:** **open** — Class S (EXT-INF-002 / S2-13)
- **Live-stack pen-test:** infra owner after SOW
