...
`RedisNonceStoreService` (in `platforms/shared/src/auth/redis-nonce-store.service.ts`) lazy-loads `ioredis` at runtime:
...
- RedisNonceStoreService: `gtcx-platforms/platforms/shared/src/auth/redis-nonce-store.service.ts`
- Staging env: `gtcx-infrastructure/infra/kubernetes/overlays/staging/patches/sovereign-staging-env.yaml`
- Sprint roadmap: `gtcx-infrastructure/docs/agile/sprints/sprint-2026-06-phase3-roadmap.md`
