...
```bash
cd 04-deploy/terraform/environments/production && terraform validate  # exit 0
cd 04-deploy/terraform/environments/staging && terraform validate     # exit 0
...
- **gtcx-protocols:** update [`from-gtcx-protocols-xr-eo-006-inf-86-closure-2026-06-05.md`](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/01-docs/04-ops/coordination/from-gtcx-protocols-xr-eo-006-inf-86-closure-2026-06-05.md)
