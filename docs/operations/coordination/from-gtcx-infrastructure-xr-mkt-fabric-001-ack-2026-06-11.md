---
title: 'outbound-ack — XR-MKT-FABRIC-001 Ghana tokenization program'
status: current
date: 2026-06-11
from: fabric-os
...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| **Alias**                 | `fabric-os`                                                                                                                                 |
| **Canonical repository**  | `gtcx-infrastructure`                                                                                                                       |
...
| **Durable inbound path**  | `gtcx-infrastructure/docs/operations/coordination/from-markets-os-*`                                                                        |
| **Durable outbound path** | `gtcx-infrastructure/docs/operations/coordination/from-gtcx-infrastructure-*`                                                               |

There is **no separate `fabric-os` git repository**. Coordination hub items for fabric
must register under `repoId: gtcx-infrastructure` with alias `fabric-os` in the
description or tags.
...
| Register hub identity under `gtcx-infrastructure`      | fabric-os             | **this ack**                                                   |
