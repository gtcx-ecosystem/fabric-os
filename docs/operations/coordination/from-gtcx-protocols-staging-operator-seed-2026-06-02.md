...
- `infra/kubernetes/overlays/staging/kustomization.yaml` — image tag `v0.4.6`
- `infra/kubernetes/overlays/staging/patches/protocols-staging-env.yaml` — seed + API key env vars
- `infra/kubernetes/overlays/staging/ingress.yaml` — `/v1/tradepass` → `gtcx-protocols-staging`
- `docs/gtm/handoffs/staging-audit-e2e-credentials-2026-06-02.md` — updated
