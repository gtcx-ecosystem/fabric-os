...
2. [`cloud-placement-aws-control-plane-2026-06-05.md`](https://github.com/gtcx-ecosystem/fabric-os/blob/5e408880a13539d34ce09ff4b5b009848fa768f8/docs/operations/coordination/sessions/cloud-placement-aws-control-plane-2026-06-05.md) — archived scope boundaries at the last pre-deletion revision
...
| **L1**          | **exploration-os** | **DONE:** XR-507 verifier DNS + Pages custom domain (smoke 200, pepper). XR-508 Supabase active (`financing_applications` queryable)          | Contract smoke + F-33 audit close                                      | [`remaining-cross-repo-work-2026-06-03.md`](https://github.com/gtcx-ecosystem/fabric-os/blob/1d8ee2462ca9f2f1f8f2aac7e2ead93f35fd1baf/docs/operations/coordination/remaining-cross-repo-work-2026-06-03.md) § XR-507/508                                                                                                                                                       |
...
| **L2**   | **bridge-os intelligence bridge** | EKS `intelligence` namespace: orchestrator Deployment, `ENABLE_COST_ROUTER` env, staging route for smoke. **Do not** stand up GKE. Phase 3: enable `gcp-ml-bridge` Terraform when GCP SA id provided. | Build/push SDK image; INT-S9-01 smoke; GCP ML in Phase 3 epic. | XR-201 done; bridge epic in `01-docs/04-ops/intelligence-phase-3-gcp-ml-bridge-epic-2026-06-05.md`                                               |
...
| bridge-os intelligence bridge | **AWS** runtime; **GCP** ML Phase 3+ | **Yes** — `gcp-ml-bridge` module only when P3 starts |
