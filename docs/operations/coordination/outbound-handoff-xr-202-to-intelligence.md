...
1. **Run the production-readiness smoke suite:**
   ...
   node 03-platform/scripts/run-production-readiness-with-vault.mjs \
     --target staging \
...
3. **Report back:**
   - Append result to `gtcx-intelligence/01-docs/04-ops/coordination/outbound-handoff-xr-202-result.md`
