...
authority_class: A
authorization_artifact: compliance-os/docs/operations/coordination/to-gtcx-infrastructure-w2-secrets-inbound-2026-06-04.md
...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| W2 prod secrets spec        | [compliance-os `to-gtcx-infrastructure-w2-secrets-inbound-2026-06-04.md`](https://github.com/gtcx-ecosystem/compliance-os/blob/main/docs/operations/coordination/to-gtcx-infrastructure-w2-secrets-inbound-2026-06-04.md) | **current** |
...
Witness file: `docs/operations/coordination/from-gtcx-infrastructure-hub-17-prod-w2-sealed-YYYY-MM-DD.md`
...
- Ticket map: [compliance-os `w2-hub-17-ticket-map-2026-06-05.md`](https://github.com/gtcx-ecosystem/compliance-os/blob/main/docs/operations/coordination/w2-hub-17-ticket-map-2026-06-05.md)
- Hub locker draft: [compliance-os `hub-inbound-w2-locker-17-draft-2026-06-04.md`](https://github.com/gtcx-ecosystem/compliance-os/blob/main/docs/operations/coordination/hub-inbound-w2-locker-17-draft-2026-06-04.md)
