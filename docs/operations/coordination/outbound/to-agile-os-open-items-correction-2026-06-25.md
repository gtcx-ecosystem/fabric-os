...
| XR-FABRIC-SPRIN                   | Fabric sprint intake placeholder (short id)                             | `done`                   | `audit/evidence/m4-baseline-roadmap-intake-latest.json`                                               |
| XR-FABRIC-SPRINT-AUTH-001         | Fabric sprint authority intake                                          | `done`                   | `audit/evidence/m4-baseline-roadmap-intake-latest.json`                                               |
| XR-FABRIC-SPRINT                  | Fabric sprint intake placeholder                                        | `done`                   | `audit/evidence/m4-baseline-roadmap-intake-latest.json`                                               |
...
| XR-FABRIC                         | Fabric intake placeholder                                               | `done`                   | `audit/evidence/m4-baseline-roadmap-intake-latest.json`                                               |
