...
**Copy target (when bundle complete):** `baseline-os/workstream/coordination/inbound/from-compliance-os-w2-locker-17-2026-06-04.md` — finalize from [compliance-os draft](https://github.com/gtcx-ecosystem/compliance-os/blob/main/docs/operations/coordination/hub-inbound-w2-locker-17-draft-2026-06-04.md).
