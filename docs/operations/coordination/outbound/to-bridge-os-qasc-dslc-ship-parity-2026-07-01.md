---
title: 'Outbound — bridge-os QASC/DSLC/SHIP parity remediation'
status: current
date: 2026-07-01
from: fabric-os
to: bridge-os
...
tier: operating
tags: [fabric-os, bridge-os, qasc, dslc, ship, fleet-parity, remediation]
review_cycle: on-change
---

# Outbound — bridge-os QASC/DSLC/SHIP parity remediation

Fabric's canonical parity witness classifies `bridge-os` as `gap`.
...
- Delegation pins present: machine/spec/aaas-audit-contract.pin.json, pm/spec/aaas-audit-contract.pin.json
...
- Delegated route: first produce a semantically valid QASC `complete` 100/100 + SIGNAL L5 witness, then run `pnpm qasc:dslc:ship:delegate:write -- --repo bridge-os` from `fabric-os`.
