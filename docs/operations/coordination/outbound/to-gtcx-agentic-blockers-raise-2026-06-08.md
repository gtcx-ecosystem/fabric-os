...
| validate-all       | **50/50 PASS**       | `node tools/scripts/validate-all.mjs`                                               |
...
| **EXT-INF-014**                        | DPA + pilot agreement                | **S**            | Blocked on EXT-INF-013                                                                | Legal packet when owner named; witness `docs/audit/vendor-outreach/zwcmp/`                                                                                                     |
...
2. **Update** [`human-external-blocker-register-2026-06.md`](https://github.com/gtcx-ecosystem/gtcx-agentic/blob/main/docs/operations/coordination/human-external-blocker-register-2026-06.md) — add **INF-XC** rows for EXT-INF-013/014/015/016 + overdue flag on 013.
