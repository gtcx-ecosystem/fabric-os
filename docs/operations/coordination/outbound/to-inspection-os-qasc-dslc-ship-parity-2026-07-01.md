---
title: 'Outbound — inspection-os QASC/DSLC/SHIP parity remediation'
status: current
date: 2026-07-01
from: fabric-os
to: inspection-os
...
tier: operating
tags: [fabric-os, inspection-os, qasc, dslc, ship, fleet-parity, remediation]
review_cycle: on-change
---

# Outbound — inspection-os QASC/DSLC/SHIP parity remediation

Fabric's canonical parity witness classifies `inspection-os` as `gap`.
...
- Delegated route: first produce a semantically valid QASC `complete` 100/100 + SIGNAL L5 witness, then run `pnpm qasc:dslc:ship:delegate:write -- --repo inspection-os` from `fabric-os`.
