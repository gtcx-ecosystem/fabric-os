---
title: 'Outbound — ledger-os QASC/DSLC/SHIP parity remediation'
status: current
date: 2026-07-01
from: fabric-os
to: ledger-os
...
tier: operating
tags: [fabric-os, ledger-os, qasc, dslc, ship, fleet-parity, remediation]
review_cycle: on-change
---

# Outbound — ledger-os QASC/DSLC/SHIP parity remediation

Fabric's canonical parity witness classifies `ledger-os` as `gap`.
