---
title: 'Outbound — nyota-ai QASC/DSLC/SHIP parity remediation'
status: current
date: 2026-07-01
from: fabric-os
to: nyota-ai
...
tier: operating
tags: [fabric-os, nyota-ai, qasc, dslc, ship, fleet-parity, remediation]
review_cycle: on-change
---

# Outbound — nyota-ai QASC/DSLC/SHIP parity remediation

Fabric's canonical parity witness classifies `nyota-ai` as `gap`.
...
- Delegated route: first produce a semantically valid QASC `complete` 100/100 + SIGNAL L5 witness, then run `pnpm qasc:dslc:ship:delegate:write -- --repo nyota-ai` from `fabric-os`.
