---
title: 'Outbound — terminal-os QASC/DSLC/SHIP parity remediation'
status: current
date: 2026-07-01
from: fabric-os
to: terminal-os
...
tier: operating
tags: [fabric-os, terminal-os, qasc, dslc, ship, fleet-parity, remediation]
review_cycle: on-change
---

# Outbound — terminal-os QASC/DSLC/SHIP parity remediation

Fabric's canonical parity witness classifies `terminal-os` as `gap`.
