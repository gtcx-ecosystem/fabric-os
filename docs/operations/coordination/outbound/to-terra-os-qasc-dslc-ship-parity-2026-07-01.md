---
title: 'Outbound — terra-os QASC/DSLC/SHIP parity remediation'
status: current
date: 2026-07-01
from: fabric-os
to: terra-os
...
tier: operating
tags: [fabric-os, terra-os, qasc, dslc, ship, fleet-parity, remediation]
review_cycle: on-change
---

# Outbound — terra-os QASC/DSLC/SHIP parity remediation

Fabric's canonical parity witness classifies `terra-os` as `gap`.
