...
- Delegated route: first produce a semantically valid QASC `complete` 100/100 + SIGNAL L5 witness, then run `pnpm qasc:dslc:ship:delegate:write -- --repo veritas-ai` from `fabric-os`.
