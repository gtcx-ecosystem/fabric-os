...
| Pre-window gates | PASS (prior arc — see `session-forensic-2026-06-14.md`) |
...
Multi-day fabric-os SECAS/Ops arc (2026-06-11 → 2026-06-14) — see [`session-forensic-2026-06-14.md`](../../../pm/ci/session-forensic-2026-06-14.md) and [`pm/ci/session-forensic-2026-06-14.md`](../../../pm/ci/session-forensic-2026-06-14.md). Canonical navigation and live vendor report ingest — owner-repo coordination only.
