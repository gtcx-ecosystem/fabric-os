...
responds_to: compliance-os/docs/operations/coordination/to-gtcx-infrastructure-w2-hub-17-staging-blockers-2026-06-05.md
---
...
**Manifest:** `infra/kubernetes/overlays/staging/compliance-os/external-secrets.yaml`
...
**Manifests:** `infra/kubernetes/overlays/staging/compliance-os/external-secrets.yaml`
...
- [ ] `kubectl apply -k infra/kubernetes/overlays/staging/compliance-os/` succeeds
