...
- Intelligence tracker: `gtcx-intelligence/docs/gtm/inbound-tickets/tracker-wire2-spec17.md`
- Protocols witness: `gtcx-protocols/docs/operations/coordination/from-gtcx-intelligence-wave2-blockers-2026-06-05.md`
- Infra ingress: `infra/kubernetes/overlays/staging/ingress.yaml`
- Infra protocols env: `infra/kubernetes/overlays/staging/patches/protocols-staging-env.yaml`
