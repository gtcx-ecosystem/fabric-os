...
- **EXT-INF-002 / H-05** — Security: sign pen-test SOW per [H-05 packet](https://github.com/gtcx-ecosystem/baseline-os/blob/main/01-docs/04-ops/coordination/ext-inf-002-pen-test-h05-packet-2026-06-05.md)
```
...
4. Status Update uses **four buckets** — [human-gates-system.md](https://github.com/gtcx-ecosystem/baseline-os/blob/main/01-docs/04-ops/human-gates-system.md) §2.
