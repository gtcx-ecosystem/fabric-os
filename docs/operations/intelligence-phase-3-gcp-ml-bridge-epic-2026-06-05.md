...
**Ecosystem placement:** [`gtcx-docs/docs/architecture/cloud-placement/gtcx-ecosystem-2026-06-05.md`](../../../gtcx-docs/01-docs/architecture/cloud-placement/gtcx-ecosystem-2026-06-05.md)
...
| Path                                     | Purpose                                                   |
| ---------------------------------------- | --------------------------------------------------------- |
| `infra/terraform/modules/gcp-ml-bridge/` | WIF OIDC provider + `intelligence-gcp-ml-bridge` IAM role |
| `infra/terraform/modules/ml-pipeline/`   | AWS S3 datasets/models + DynamoDB registry (existing)     |
