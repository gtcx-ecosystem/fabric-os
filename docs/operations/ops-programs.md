...
| **RevOps**        | CRO office — pricing, unit economics, revenue analytics, GTM revenue motion     | bridge-os (+ fabric register host)      | **GTMaaS** _(+ economics)_ | P44         | [gtm-as-a-service.md](./gtm-as-a-service.md)              |
| **PayOps**        | Payment _execution_ — billing rails, Stripe/webhooks, checkout, payouts         | fabric-os substrate + product repos     | _(execution)_              | —           | `bridge-os/pm/spec/payops-domain-registry.json`           |
