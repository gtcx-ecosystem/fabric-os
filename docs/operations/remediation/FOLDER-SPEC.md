---
title: 'operations/remediation/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/remediation']
review_cycle: on-change
---

# `docs/operations/remediation/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/remediation/ narrative and specs for fabric-os.
