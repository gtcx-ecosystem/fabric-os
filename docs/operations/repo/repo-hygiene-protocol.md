---
title: 'Repo hygiene protocol - fabric-os'
status: current
date: 2026-06-18
owner: fabric-os
...
# Repo hygiene protocol - fabric-os
...
Keep the repository root a closed workspace with only allowlisted bootstrap files and v5 hubs. Governance docs for repo hygiene live under `docs/operations/repo/`.
