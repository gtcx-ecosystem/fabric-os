---
title: 'operations/runbooks/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/runbooks']
review_cycle: on-change
---

# `docs/operations/runbooks/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/runbooks/ narrative and specs for fabric-os.
