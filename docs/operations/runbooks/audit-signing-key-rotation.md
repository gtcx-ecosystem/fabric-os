...
1. **Scheduled** — every 365 days, per the rotation cadence in `docs/security/credential-rotation-log.md`
...
- [`docs/security/credential-rotation-log.md`](../../security/credential-rotation-log.md) — historical rotation record
- [`docs/security/threat-model-2026-05.md`](../../security/threat-model-2026-05.md) — T-1, E-1, E-3 threat categories
