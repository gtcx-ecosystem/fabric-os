...
| Artifact         | Path                                             | Role                      |
| ---------------- | ------------------------------------------------ | ------------------------- |
| Hygiene register | `pm/hygiene-friction-register.json`              | HaaS friction state       |
| Roadmap          | `pm/haas-roadmap.json`                           | Fabric-owned HaaS roadmap |
...
- Keep generated evidence under `audit/`, `pm/ci/`, or the lane-specific Ops
