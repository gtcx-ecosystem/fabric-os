...
| Alert routing validation  | Every CI run  | `tools/scripts/incident-drill-validator.mjs` green in CI     |
...
- [\docs/engineering/security/protocols-cryptographic-inventory.md](../../security/security-architecture.md)
