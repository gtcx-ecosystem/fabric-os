...
- [`audit/score-evidence-ledger.json`](../../../../audit/archive/legacy-docs-audit/score-evidence-ledger.json) — link each onboarded tenant's first signed record.
- [`ops/security/narrative/break-glass-procedure.md`](../../../../ops/security/narrative/break-glass-procedure.md) — tenant escalation paths.
