...
kustomize build infra/kubernetes/overlays/staging | grep -E "name:.*audit-key"
...
- ER-2-04 incident: `docs/operations/coordination/from-gtcx-infrastructure-compliance-gateway-staging-healthy-2026-06-04.md`
- Base kustomization: `infra/kubernetes/base/kustomization.yaml`
- Staging patch: `infra/kubernetes/overlays/staging/patches/compliance-gateway-audit-key-secret-ref.yaml`
