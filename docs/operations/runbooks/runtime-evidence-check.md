...
1. **Script presence** — `tools/control-plane/generate-release-evidence.mjs` exists.
...
```bash
node tools/scripts/runtime-evidence-check.mjs
```
...
| ------------------------------------------------ | --------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `generate-release-evidence.mjs missing`          | Script deleted or moved                       | Check `tools/control-plane/` exists; restore from git if missing                                       |
...
| `bundle missing schemaVersion or release.commit` | Schema regression in evidence generator       | File a bug against `tools/control-plane/generate-release-evidence.mjs`; do not bypass                  |
