...
- Base manifest created at `infra/kubernetes/base/services/sovereign/deployment.yaml`
- Added to staging kustomization (`infra/kubernetes/overlays/staging/kustomization.yaml`)
...
- `infra/kubernetes/overlays/staging/ingress.yaml` now includes:
...
Update `infra/kubernetes/overlays/staging/ingress.yaml` to include both certificates:
...
- Ingress: `infra/kubernetes/overlays/staging/ingress.yaml`
- Sovereign base manifest: `infra/kubernetes/base/services/sovereign/deployment.yaml`
- Staging kustomization: `infra/kubernetes/overlays/staging/kustomization.yaml`
