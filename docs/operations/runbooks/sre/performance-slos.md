...
- `01-docs/10-compliance/controls-matrix.md` — compliance control evidence
- `01-docs/05-audit/execution-roadmap.md` — canonical execution plan + milestone stories
- `01-docs/engineering/test-strategy.md` — coverage gate configuration
