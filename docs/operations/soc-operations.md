...
| ----------------------- | ------------------------------------------------------- | --------- |
| Unauthorized IAM access | `01-docs/04-ops/runbooks/iam-compromise-response.md`    | Published |
| Kubernetes pod escape   | `01-docs/04-ops/runbooks/k8s-incident-response.md`      | Published |
| Data exfiltration alert | `01-docs/04-ops/runbooks/data-exfiltration-response.md` | Draft     |
| Ransomware detection    | `01-docs/04-ops/runbooks/ransomware-response.md`        | Draft     |
| Insider threat          | `01-docs/04-ops/runbooks/insider-threat-response.md`    | Draft     |
| Nation-state APT        | `01-docs/04-ops/runbooks/apt-response.md`               | Draft     |
