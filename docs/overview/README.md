...
**For a CTO:** GTCX Infrastructure is the deployment, operations, and security platform for the GTCX ecosystem. It provides Terraform modules for AWS infrastructure, Kubernetes manifests for container orchestration, Docker images for services, and operational tooling for compliance, anomaly detection, replay protection, deployment gating, WORM audit storage, and chaos engineering. Current internal engineering state is **IR ≈ 7.7/10** (see `01-docs/05-audit/latest.json` + `01-docs/05-audit/master-audit-2026-06-02.md`). Staging DNS/TLS for authority DID resolution (INF-49) is verified; production sovereign authority keys remain gated on infra **#86** (HSM ceremony) → protocols **#61**.
...
| Item                         | Current State                                                                                                                                            |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Latest master audit          | [`audit/archive/legacy-docs-audit/master-audit-post-sprint-2026-05-27.md`](../../audit/archive/legacy-docs-audit/master-audit-post-sprint-2026-05-27.md) |
| 10/10 remediation plan       | [`audit/archive/legacy-docs-audit/10-10-remediation-plan-2026-05-27.md`](../../audit/archive/legacy-docs-audit/10-10-remediation-plan-2026-05-27.md)     |
...
**How This Repo Helps:** Tendai uses `04-deploy/terraform/modules/` to provision infrastructure with security defaults (encrypted storage, least-privilege IAM, VPC isolation). The `03-platform/tools/deployment-guard/` enforces approval tickets for production changes. The `03-platform/tools/scripts/audit-with-acceptance.mjs` generates SOC 2 evidence artifacts automatically.
...
**How This Repo Helps:** Dr. Nkosi reviews `01-docs/10-compliance/soc2-readiness-checklist.md` (70% complete) and `01-docs/09-security/nist-800-53-mapping.md` (53 controls mapped). The WORM audit storage module provides 7-year immutable logs. AWS Config compliance rules show real-time compliance status. The pen-test scope document (`01-docs/05-audit/pen-test-scope-2026.md`) demonstrates proactive security engagement.

**Workflow Unlocked:** Dr. Nkosi receives a sandbox application from GTCX. She opens `01-docs/10-compliance/soc2-readiness-checklist.md` and sees mapped controls with file-path citations. She verifies `01-docs/09-security/nist-800-53-mapping.md` for AC-2 (Account Management) and AU-6 (Audit Review). She checks the AWS Config dashboard and sees 8 managed rules all COMPLIANT. She notes the pen-test is pending and schedules a follow-up review for 90 days post-engagement.
...
- SOC 2 readiness checklist (70% complete, `01-docs/10-compliance/soc2-readiness-checklist.md`)
- NIST 800-53 mapping (53 controls, `01-docs/09-security/nist-800-53-mapping.md`)
- ISO 27001 scope document (`01-docs/08-gtm/regulatory/iso27001-isms-scope.md`)
- AWS Config compliance rules (13 rules, all COMPLIANT)
- CloudTrail production logs (KMS-encrypted, 7-year retention)
- Pen-test scope and vendor shortlist (`01-docs/05-audit/pen-test-scope-2026.md`)
...
- **API contracts:** OpenAPI specs in `01-docs/api/` (where applicable)

### 5.4 Sales Collateral

Technical specifications available for sales reference:

- `01-docs/architecture/anomaly-detection.md`
- `01-docs/engineering/gtcx-platforms-m3-contract.md`
- `01-docs/09-security/security-architecture.md`
- `01-docs/04-ops/runbooks/` (25 runbooks)
...
| ------------------ | --------------------------------------- | ------------------------------------ | ---------- | --------------------- | -------------------- |
| replay-protection  | `03-platform/tools/replay-protection/`  | Offline nonce/signature verification | Production | 85% stmts, 69% branch | gtcx-protocols       |
| compliance-gateway | `03-platform/tools/compliance-gateway/` | Regulatory compliance API            | Beta       | Measured              | gtcx-platforms       |
...
| SOC 2 Type 1                  | In Progress | Checklist 70% complete (`01-docs/10-compliance/soc2-readiness-checklist.md`) | Auditor not engaged; pen-test pending             |
| STRIDE Threat Model           | Present     | `01-docs/09-security/threat-model.md`                                        | Not independently validated                       |
...
- Vault TLS disabled (`04-deploy/terraform/modules/vault/main.tf:219`)
...
5. **Run verification:** `bash 04-deploy/03-platform/scripts/validate.sh quick`
6. **Read ADRs:** `01-docs/architecture/decisions/` — start with ADR-007 (mTLS mesh) and ADR-009 (deprecation)
...
- **Safety rules:** Read `01-docs/01-agents/workflows/agent-safety-rules.md` — three-tier authority (Autonomous / Requires Approval / Never)
...
Per the [10/10 roadmap](../../audit/archive/legacy-docs-audit/10-10-roadmap-2026-05-17.md):
...
| ---------------------------------------------------------------- | ------------------------ | -------------------------------- |
| `01-docs/05-audit/master-audit-2026-05-17.md`                    | Bank-grade certification | Security, compliance, investors  |
| `01-docs/05-audit/10-10-roadmap-2026-05-17.md`                   | Path to 10.0             | Engineering, product, executives |
| `01-docs/architecture/system-architecture-spec.md`               | System architecture      | Engineers, architects            |
| `01-docs/09-security/threat-model.md`                            | Threat model             | Security engineers, auditors     |
| `01-docs/10-compliance/soc2-readiness-checklist.md`              | SOC 2 evidence           | Compliance, buyers               |
| `01-docs/08-gtm/regulatory/regulatory-notification-templates.md` | Regulatory templates     | Compliance, legal                |
| `01-docs/04-ops/runbooks/`                                       | Operational runbooks     | SRE, on-call engineers           |
| `01-docs/architecture/decisions/adr-index.md`                    | Architecture decisions   | Engineers, architects            |
...
_This document is generated from repo state and audit artifacts. For the canonical source of truth on scores and findings, see [master-audit-post-sprint-2026-05-27.md](../../audit/archive/legacy-docs-audit/master-audit-post-sprint-2026-05-27.md)._
