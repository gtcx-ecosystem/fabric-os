...
**Semantic versioning**
The versioning scheme for packages and schemas: `MAJOR.MINOR.PATCH`. MAJOR bumps indicate breaking changes requiring migration. See [`canon-os release governance`](https://github.com/gtcx-ecosystem/canon-os/blob/main/docs/operations/release/versioning-policy.md) for the SemVer + release-tagging discipline.
