---
title: 'reference/legacy-top-level/ — folder provisioning'
status: current
date: 2026-06-15
owner: fabric-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'reference/legacy-top-level']
review_cycle: on-change
---

# `docs/reference/legacy-top-level/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

reference/legacy-top-level/ narrative and specs for fabric-os.
