...
| Story                 | Status      | Notes                                            |
| --------------------- | ----------- | ------------------------------------------------ |
| COMPOSITE-RESTORE-100 | in_progress | Restore composite ≥100 for SECAS-S4-supply-chain |
| Q3-FABRIC-03          | open        | SECAS supply-chain gates closure                 |
| Q3-FABRIC-04          | open        | Fleet observability witness                      |
