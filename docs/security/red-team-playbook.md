...
- GTCX threat model: `docs/security/threat-model.md`
- GTCX incident response: `docs/security/security-architecture.md`
- GTCX zero trust assessment: `docs/security/zero-trust-assessment.md`
