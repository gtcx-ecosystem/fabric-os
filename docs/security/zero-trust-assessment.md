...
| RASP             | Not implemented | No runtime application self-protection (see `docs/security/rasp-integration-guide.md`) |
...
7. Publish updated assessment to `docs/security/zero-trust-assessment.md`
...
- GTCX RASP integration guide: `docs/security/rasp-integration-guide.md`
