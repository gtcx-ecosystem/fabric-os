---
title: 'infra/scripts/ — Runtime Operations Scripts'
status: 'current'
date: '2026-05-24'
...
# infra/scripts/ — Runtime Operations Scripts
...
- Scripts that runbooks invoke directly (`docs/operations/runbooks/*` should reference scripts here)
...
- CI validators / linters / dev-loop tooling → use [`tools/scripts/`](../../tools/scripts/README.md)
- Cross-repo coordination / agent-sync utilities → use [`scripts/`](../../scripts/README.md)
...
| [`deploy.sh`](./deploy.sh)                                                       | Production canary deployment with approval-ticket gate | `docs/operations/runbooks/deploy.md`                    |
| [`dr-test.sh`](./dr-test.sh)                                                     | DR drill against staging                               | `docs/operations/runbooks/disaster-recovery.md`         |
| [`fine-tune-workflow.sh`](./fine-tune-workflow.sh)                               | ML fine-tune workflow orchestration                    | `docs/operations/runbooks/fine-tune-workflow-*.md`      |
| [`init-secrets.sh`](./init-secrets.sh)                                           | Initialize K8s secrets from AWS Secrets Manager        | New-environment setup                                   |
| [`migrate-state.sh`](./migrate-state.sh)                                         | Terraform state migration                              | `docs/operations/runbooks/terraform-state-migration.md` |
| [`migrate.sh`](./migrate.sh)                                                     | Database migration runner                              | `docs/operations/runbooks/migrate.md`                   |
...
- [`scripts/`](../../scripts/README.md) — cross-repo automation + agent-sync
- [`tools/scripts/`](../../tools/scripts/README.md) — CI validators + dev tooling
