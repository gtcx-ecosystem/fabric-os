...
#   ./scripts/bootstrap-aws.sh --skip-region    # If af-south-1 already enabled
#   ./scripts/bootstrap-aws.sh --skip-oidc      # Skip GitHub OIDC setup
#
...
echo "     ./infra/scripts/deploy.sh production --approval-ticket=GTCX-001"
echo ""
