...
#   ./scripts/bootstrap-staging.sh --skip-region    # If af-south-1 already enabled
#   ./scripts/bootstrap-staging.sh --skip-oidc      # Skip GitHub OIDC setup
#
...
ENV_DIR="${PROJECT_ROOT}/infra/terraform/environments/staging"
