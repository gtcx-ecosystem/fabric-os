...
| UX-P05 | No machine/ux SoR — engineering specs accumulate without operator journeys | This `machine/ux` tree + EXR operator pack                             | platform-operator  | all P0 JTBDs                 | P0       | `inferred-from-audit` — A1 gap                                                         |
...
1. **UX-P05** → complete traceability (this pass) + `machine:ux:check` in bridge-os fleet harness.
