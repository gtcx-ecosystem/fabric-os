...
Engineer in `compliance-os`, `markets-os`, `terminal-os`, or the `bridge-os` intelligence bridge who needs staging ingress, secrets, GHCR pull, or WAF paths — without owning the AWS control plane. Files inbound handoffs (`to-fabric-os-*`) and consumes outbound seals.
