...
const ACCEPTANCE_SCRIPT = join(dirname(fileURLToPath(import.meta.url)), 'repo-cleanup-mpr-signal-acceptance.mjs');
const BASE = join(dirname(ACCEPTANCE_SCRIPT), '..', '..');

const res = spawnSync(process.execPath, [ACCEPTANCE_SCRIPT, '--json'], {
  cwd: BASE,
  encoding: 'utf8',
...
console.log(`Repository Acceptance Score: ${score}/100`);
