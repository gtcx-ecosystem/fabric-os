...
const script = path.join(repoRoot, 'platform', 'tools', 'control-plane', 'validate-environment.mjs');
const ctl = path.join(repoRoot, 'platform', 'tools', 'control-plane', 'gtcx-ctl.mjs');
