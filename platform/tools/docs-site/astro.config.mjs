...
//
// Source-of-truth markdown lives in `01-docs/external/docs-site/` at the repo
// root so the public docs are version-controlled alongside the substrate
// that they describe. `03-platform/scripts/sync-content.mjs` mirrors that directory
// into `03-platform/src/content/01-docs/` before Astro reads it; we deliberately avoid
