#!/usr/bin/env node
/**
 * Import baseline-os cost-stats JSON into docs/audit/evidence (SIGNAL INF-002).
 * Usage: node scripts/ops/import-baseline-cost-stats.mjs [--input=path]
 */
...
const OUT = join(ROOT, 'docs/audit/evidence/baseline-cost-stats-latest.json');
