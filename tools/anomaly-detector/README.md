...
node tools/anomaly-detector/detector.mjs \
  --synthetic-data=tools/anomaly-detector/test-fixtures/synthetic-metrics.json
```
...
node --test tools/anomaly-detector/tests/detector.test.mjs
```
