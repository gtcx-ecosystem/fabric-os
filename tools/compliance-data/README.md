...
```bash
# In your project:
node node_modules/@gtcx/compliance-data/scripts/verify-catalog.mjs

# Or copy `scripts/verify-catalog.mjs` from the package and run:
...
> https://github.com/gtcx-ecosystem/gtcx-infrastructure/tree/main/tools/compliance-data
...
4. Re-sign: `COMPLIANCE_DATA_SIGNING_KEY_B64=... node scripts/sign-catalog.mjs`
