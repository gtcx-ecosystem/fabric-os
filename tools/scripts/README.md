---
title: 'tools/scripts/ — Developer + CI Validators'
status: 'current'
date: '2026-05-24'
...
# tools/scripts/ — Developer + CI Validators
...
- Validators run by [`tools/scripts/validate-all.mjs`](./validate-all.mjs) as master-validation gates
...
- Cross-repo coordination / agent-sync → use [`scripts/`](../../scripts/README.md)
...
These run as part of `node tools/scripts/validate-all.mjs`:
...
- [`infra/scripts/`](../../infra/scripts/README.md) — runtime operations
- [`scripts/`](../../scripts/README.md) — cross-repo automation
- [`tools/policy/`](../policy/) — Kyverno policy source these validators check against
