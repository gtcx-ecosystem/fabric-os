 ...
 *   node tools/scripts/docs-standard-validator.mjs --dump-baseline > .docs-exceptions.json
 *   node tools/scripts/docs-standard-validator.mjs --baseline=.docs-exceptions.json
 */
