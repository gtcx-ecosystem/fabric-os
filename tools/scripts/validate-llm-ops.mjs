...
const REQUIRED = [
  'infra/monitoring/dashboards/llm-ops.json',
  'infra/monitoring/alerts/llm-ops-alerts.yml',
  'infra/kubernetes/overlays/staging/monitoring/kustomization.yaml',
  'infra/kubernetes/overlays/staging/patches/compliance-gateway-metrics.yaml',
  'tools/compliance-gateway/src/llm-trace.mjs',
...
const dashboard = JSON.parse(
  readFileSync(path.join(ROOT, 'infra/monitoring/dashboards/llm-ops.json'), 'utf8'),
);
...
const alerts = readFileSync(
  path.join(ROOT, 'infra/monitoring/alerts/llm-ops-alerts.yml'),
  'utf8',
);
...
const patch = readFileSync(
  path.join(ROOT, 'infra/kubernetes/overlays/staging/patches/compliance-gateway-metrics.yaml'),
  'utf8',
);
